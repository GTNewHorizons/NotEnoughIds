...
public enum Name
{
    ...
    hooks_getBlockData(Name.hooks, "getBlockData", (String)null, (String)null, "(Lnet/minecraft/world/chunk/storage/ExtendedBlockStorage;)[B"), 
    hooks_setBlockData(Name.hooks, "setBlockData", (String)null, (String)null, "(Lnet/minecraft/world/chunk/storage/ExtendedBlockStorage;[BI)V"), 
    hooks_writeChunkToNbt(Name.hooks, "writeChunkToNbt", (String)null, (String)null, "(Lnet/minecraft/nbt/NBTTagCompound;Lnet/minecraft/world/chunk/storage/ExtendedBlockStorage;)V"), 
    hooks_readChunkFromNbt(Name.hooks, "readChunkFromNbt", (String)null, (String)null, "(Lnet/minecraft/world/chunk/storage/ExtendedBlockStorage;Lnet/minecraft/nbt/NBTTagCompound;)V"), 
    hooks_getBlockId(Name.hooks, "getBlockId", (String)null, (String)null, "(Lnet/minecraft/world/chunk/storage/ExtendedBlockStorage;III)I"), 
    hooks_getBlockById(Name.hooks, "getBlock", (String)null, (String)null, "(Lnet/minecraft/world/chunk/storage/ExtendedBlockStorage;III)Lnet/minecraft/block/Block;"), 
    hooks_setBlockId(Name.hooks, "setBlockId", (String)null, (String)null, "(Lnet/minecraft/world/chunk/storage/ExtendedBlockStorage;IIII)V"), 
    hooks_getIdFromBlockWithCheck(Name.hooks, "getIdFromBlockWithCheck", (String)null, (String)null, "(Lnet/minecraft/block/Block;Lnet/minecraft/block/Block;)I"), 
    ...
    s21_undefined2(Name.s21, "func_149269_a", "a", (String)null, "(Lnet/minecraft/world/chunk/Chunk;ZI)Lnet/minecraft/network/play/server/S21PacketChunkData$Extracted;"), 
    ...
    ub_bud_replaceChunkOres_world(Name.ub_bud, "replaceChunkOres", (String)null, (String)null, "(IILnet/minecraft/world/World;)V"), 
    ub_bud_replaceChunkOres_iChunkProvider(Name.ub_bud, "replaceChunkOres", (String)null, (String)null, "(Lnet/minecraft/world/chunk/IChunkProvider;II)V"), 
    MFQM("MoreFunQuicksandMod/main/MFQM"), 
    MFQM_preInit(Name.MFQM, "preInit", (String)null, (String)null, "(Lcpw/mods/fml/common/event/FMLPreInitializationEvent;)V");
