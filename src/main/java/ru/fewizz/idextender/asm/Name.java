...
public enum Name {
    ...
    hooks_getBlockById(Name.hooks, "getBlock", null, null,
            "(Lnet/minecraft/world/chunk/storage/ExtendedBlockStorage;III)Lnet/minecraft/block/Block;"),
    hooks_setBlockId(Name.hooks, "setBlockId", null, null,
            "(Lnet/minecraft/world/chunk/storage/ExtendedBlockStorage;IIII)V"),
    hooks_getIdFromBlockWithCheck(Name.hooks, "getIdFromBlockWithCheck", null, null,
    ...
    ebs_getBlock(Name.extendedBlockStorage, "getBlockByExtId", "a", "func_150819_a",
    ...
    acl_writeChunkToNBT(Name.acl, "writeChunkToNBT", "a", "func_75820_a",
