...
public class Constants {
    ...
    public static final int BLOCK_ID_MASK = 0xffff; // 65535
    ...
    public static final int newEbsSize =
            ebsIdArraySize + 3 * ebsIdArrayLength / 2; // ids + 3 * nibble (meta, blocklight, skylight)
