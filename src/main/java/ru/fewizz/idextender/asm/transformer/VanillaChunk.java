...
public class VanillaChunk implements IClassNodeTransformer {
    ...
    public void transform(ClassNode cn) {
        ...
        AbstractInsnNode loopBegin = AsmUtil.findVarInsnNode(method.instructions.getFirst(), ISTORE, 8)
                .getPrevious(); // Iconst0
        AbstractInsnNode nextLoopBegin =
                AsmUtil.findVarInsnNode(loopBegin, ISTORE, 8).getPrevious(); // Too
